...
// Function which accumulates gyro and accelerometer data before device initialization. It calculates the average
...
// At end of sample accumulation, turn off FIFO sensor read
  ...
  for (ii = 0; ii < packet_count; ii++) {
   ...
   accel_bias[0] /= packet_count; // Normalize counts to get average values
